...
> Screenshot: VirtualBox internal network configuration
...
> Screenshot: Splunk Add New Index dialog showing 
> "endpoint" index being created
...
> Screenshot: inputs.conf open in Notepad showing 
> full configuration with all event sources
...
> Screenshot: Splunk indexes showing "endpoint" status 
> as Active alongside other system indexes
...
> Screenshot: MSFvenom command executing on Kali 
> terminal creating Resume1.pdf.exe
...
> Screenshot: Browser on Windows VM showing directory 
> listing with Resume.pdf.exe and Resume1.pdf.exe 
> available for download

> Screenshot: Python HTTP server terminal showing 
> 192.168.20.12 (Windows VM) successfully downloading 
> Resume1.pdf.exe with HTTP 200 response
...
> Screenshot: Metasploit terminal showing successful 
> Meterpreter session with shell access and ipconfig 
> output confirming victim machine IP 192.168.20.12
...
> Screenshot: Splunk showing 3,723 events in endpoint 
> index with Security and Sysmon events visible
